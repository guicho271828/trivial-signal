...
(dolist (symbol '(+SIGHUP+ +SIGINT+ +SIGQUIT+ +SIGILL+ +SIGABRT+ +SIGFPE+ +SIGKILL+ +SIGSEGV+
                  +SIGPIPE+ +SIGALRM+ +SIGTERM+ +SIGUSR1+ +SIGUSR2+ +SIGCONT+ +SIGCHLD+
                  +SIGSTOP+ +SIGTSTP+ +SIGTTIN+ +SIGTTOU+ +SIGBUS+ +SIGPOLL+ +SIGPROF+
                  +SIGSYS+ +SIGTRAP+ +SIGURG+ +SIGVTALRM+ +SIGXCPU+ +SIGXFSZ+ +SIGIO+
                  +SIGEMT+ +SIGTKFLT+ +SIGIO+ +SIGCLD+ +SIGPWR+ +SIGINFO+ +SIGLOST+
                  +SIGWINCH+ +SIGUNUSED+ +SIGRTMIN+ +SIGRTMIN+1+ +SIGRTMIN+2+ +SIGRTMIN+3+
                  ...
                  +SIGRTMAX-1+ +SIGRTMAX+ +SIGTHR+ +SIGLIBRT+))
  (handler-case
